...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/pics/gui_res/white_icons/exclamation.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_config_swipe.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/pics/gui_res/white_icons/viber.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.page, icon2, "")
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setGeometry(QtCore.QRect(0, 0, 423, 307))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/pics/gui_res/white_icons/email.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.page_2, icon3, "")
        self.page_3 = QtWidgets.QWidget()
        self.page_3.setGeometry(QtCore.QRect(0, 0, 423, 307))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/pics/gui_res/white_icons/asmallworld.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_7 = QtWidgets.QLabel(self.tab_setup_types)
        self.label_7.setMaximumSize(QtCore.QSize(20, 20))
        self.label_7.setText("")
        self.label_7.setPixmap(QtGui.QPixmap(":/pics/gui_res/white_icons/exclamation.png"))
        ...
        self.page_4.setGeometry(QtCore.QRect(0, 0, 423, 420))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/white_icons/gui_res/white_icons/equalizer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox_2.addItem(self.page_4, icon5, "")
        self.page_5 = QtWidgets.QWidget()
        self.page_5.setGeometry(QtCore.QRect(0, 0, 423, 420))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.table_columns_exportnames.sizePolicy().hasHeightForWidth())
        self.table_columns_exportnames.setSizePolicy(sizePolicy)
        self.table_columns_exportnames.setMinimumSize(QtCore.QSize(0, 330))
        self.table_columns_exportnames.setMaximumSize(QtCore.QSize(16777215, 330))
        self.table_columns_exportnames.setBaseSize(QtCore.QSize(0, 350))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/white_icons/gui_res/files_ico/xls.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox_2.addItem(self.page_5, icon6, "")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_25.setText(_translate("Form", "Відображати як:  "))
        ...
        self.label_24.setText(_translate("Form", "Відображати як:  "))
        ...
        self.label_27.setText(_translate("Form", "Відображати як:  "))
        ...
        self.label_26.setText(_translate("Form", "Відображати як:  "))
        ...
        self.label_28.setText(_translate("Form", "Відображати як:  "))
        ...
        self.label_29.setText(_translate("Form", "Відображати як:  "))
        ...
        self.label_8.setText(_translate("Form", "Редагування другої колонки змінює заголовки у опрацьованих таблицях "))
